package com.example.concurrentCollection.concurrenthashmap;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			threads[i] = new Thread(hashFiller,"Thread-***********"+i);
			threads[i].start();
		}
		...
		/*
		 * userHash.forEach(10, (user, list) -> { System.out.printf("%s: %s: %d\n",
